...
days['2026-07-06'] = {
  ...
  phase: 'summer',
  type: 'plan',
  summary: 'Morning at the thatched house, a walk in Aventoft on the border, rainy afternoon in Tønder & the royal garden at Møgeltønder 🇩🇰.',
  blocks: [
    { kind: 'note', html: '<p>📍 A slow morning at the thatched-roof holiday house, then a walk through <strong>Aventoft</strong> — the last village before Denmark — and across the border to <strong>Tønder</strong>. Cobbled pedestrian streets under Dannebrog bunting, umbrellas out all afternoon. Just missed the T&oslash;nder Marked &amp; Oldtimer-Treffen (Jul 4, per the events board in the Midtby). To finish, the rainy allee of <strong>Schackenborg Slotshave</strong> in Møgeltønder — the castle garden of Prince Joachim&rsquo;s former royal residence, a few minutes west of Tønder.</p>' },
    ...
    { kind: 'photo', src: '/trips/2026/germany/photos/toender-garden.jpg', alt: 'The rainy allee of Schackenborg Slotshave, the royal castle garden in Møgeltønder' },
...
days['2026-07-08'] = {
  ...
  blocks: [
    ...
    { kind: 'note', html: '<p>📸 <strong>As it happened:</strong> a slow café breakfast on Bülowstraße instead of the market, then the U2 from the elevated Bülowstraße platform straight into East Berlin — out at Alexanderplatz into full sunshine, Buddy Bear in the station, Fernsehturm overhead.</p>' },
    { kind: 'photo', src: '/trips/2026/germany/photos/berlin-schoeneberg-fruehstueck.jpg', alt: 'Café breakfast in Schöneberg — börek, tea and Berlin street life outside' },
    { kind: 'photo', src: '/trips/2026/germany/photos/berlin-buelowstrasse.jpg', alt: 'The three waiting to cross under the U2 viaduct on Bülowstraße' },
    { kind: 'photo', src: '/trips/2026/germany/photos/berlin-u2-bahnsteig.jpg', alt: 'A yellow U2 train pulling into the iron-and-glass Bülowstraße elevated platform' },
    { kind: 'photo', src: '/trips/2026/germany/photos/berlin-buddy-baer.jpg', alt: 'Luca with the Buddy Bear wearing the U-Bahn map, Alexanderplatz station' },
    { kind: 'photo', src: '/trips/2026/germany/photos/berlin-alexanderplatz.jpg', alt: 'Climbing out of the U-Bahn under the Alexanderplatz sign into the sun' },
    { kind: 'photo', src: '/trips/2026/germany/photos/berlin-fernsehturm.jpg', alt: 'The Fernsehturm in full July blue from the gardens by the Marienkirche' },
